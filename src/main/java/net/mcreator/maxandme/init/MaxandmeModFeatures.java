...
import net.mcreator.maxandme.world.features.ores.TinOreFeature;
...
public class MaxandmeModFeatures {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, MaxandmeMod.MODID);
