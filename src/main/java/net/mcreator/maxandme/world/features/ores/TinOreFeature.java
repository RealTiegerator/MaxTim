...
package net.mcreator.maxandme.world.features.ores;
...
public class TinOreFeature extends OreFeature {
	...
	private static class TinOreFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<TinOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<TinOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
